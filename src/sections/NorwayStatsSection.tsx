    ...
    <section className="relative py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <p className="text-sm font-medium text-blue-400 uppercase tracking-wider mb-3">Norske LinkedIn-tall du bør kjenne til</p>
          ...
          {stats.map((stat, i) => (
            <div
              ...
              className={`group relative p-6 rounded-2xl transition-all ${
                stat.highlight
                  ? 'bg-gradient-to-b from-blue-500/10 to-purple-500/5 border-2 border-blue-500/30'
                  : 'bg-white/[0.02] border border-white/5 hover:border-white/10'
              }`}
            >
              <div className={`w-10 h-10 rounded-xl flex items-center justify-center mb-4 ${
                stat.highlight ? 'bg-blue-500/10 text-blue-400' : 'bg-white/5 text-zinc-400'
              }`}>
                <stat.icon size={20} />
              </div>
